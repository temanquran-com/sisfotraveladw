    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h1 class="text-capitalize mb-4">PT. AET DUNIA WISATA (ADW TRAVEL)</h1>
          <p class="mb-4">Merupakan Tour And Travel yang bergerak tidak hanya di bidang Umrah saja, tapi juga ada wisata Religi, Tour ke domistik Maupun Wisata ke  Negara ada dia Asia dan Eropa. Perusahaan ini bergerak Sudah Dari Tahun 2019 hingga saat ini.</p> <a type="button"
      ...
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async"
            src="{{ asset('frontend/images/banner_home.png') }}"
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="section-title pt-4">
          <p class="text-primary text-uppercase fw-bold mb-3">Kenapa Memilih</p>
          <h1>ADW TRAVEL</h1>
          <p>Pasti Berangkat | Pembayaran Aman | Komunikasi 24/7</p>
        </div>
      </div>
